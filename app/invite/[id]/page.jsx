...
export default function InviteViewPage() {
  ...
  return (
    <div className="netflix-luxury-container">
      {/* നിങ്ങൾ നൽകിയ നെറ്റ്‌ലിഫൈ സൈറ്റിലെ അതേ കൃത്യമായ CSS കോഡ് */}
      ...
      {/* 9. PHOTO GALLERY (മറ്റു ഫോട്ടോകൾ ഉണ്ടെങ്കിൽ) */}
      {gallery.length > 3 && (
        <section className="section bg-[#10080a] py-16">
          <div className="max-w-5xl mx-auto text-center space-y-6">
            <p className="eyebrow">Captured Memories</p>
            <h2 className="text-3xl sm:text-4xl font-serif text-[#c7a36a]">Glimpses of Forever</h2>
